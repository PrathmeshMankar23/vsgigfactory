    ...
    <div className="login-page">
      ...
      <div className="expert-card">
        ...
        <div className="expert-buttons-container">
          <button className="expert-btn" onClick={handleAgencyBtnClick}>
            Apply as an Agency
          </button>
      ...
      {showFreelancerForm && (
        <FreelancerForm onClose={closeFreelancerForm} />
      )}

      {/* ===== AGENCY APPLICATION FORM MODAL ===== */}
      {showAgencyForm && (
        <AgencyForm onClose={closeAgencyForm} />
      )}
